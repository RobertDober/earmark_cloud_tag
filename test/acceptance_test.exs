defmodule EarmarkTagCloudTest do
  ...
  describe "no errors, custom settings" do
    ...
    test "set after" do
      ...
      expected = 
      {[ "<div class=\"beta and gamma earmark-tag-cloud\" style=\"font-family: Arial;\">",
        "  <span style=\"color: #000000; font-size: 10pt; font-weight: 200;\">ruby</span>",
        "  <span style=\"color: #f3f3f3; font-size: 30pt; font-weight: 400;\">elixir</span>",
        "</div>"
      ], []} 
  ...
  describe "errors and custom settings" do
    test "one complex example should be enough" do
      ...
      expected = 
      {[ "<div class=\"earmark-tag-cloud\" id=\"hello-world\" style=\"font-family: Helvetica U Name It;\">",
        "  <span style=\"color: #f8f8f8; font-size: 12pt; font-weight: 100;\">elixir is king</span>",
        "  <span style=\"color: #cacaca; font-size: 30pt; font-weight: 400;\">set</span>",
        "</div>"
      ], [
        {:error, 89, "missing one or more of necessary integer values (font-size font-weight gray-scale) at end of tag line"},
